...
class Bot(asynchat.async_chat):
    ...
    def error(self, trigger=None):
        ...
        try:
            ...
            try:
                ...
                log_filename = os.path.join(self.config.core.logdir, self.config.core.nick + '.exceptions.log')
    ...
    def handle_error(self):
        ...
        # TODO: make not hardcoded
        logfile = codecs.open(
            os.path.join(self.config.core.logdir, self.config.core.nick + '.exceptions.log'),
            'a',
            encoding='utf-8'
        )
